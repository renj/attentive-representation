...
class AttnDecoderRNN(nn.Module):
    ...
    def forward(self, input, hidden, encoder_output, encoder_outputs):
        ...
        if self.debug is True:
            ...
            print('embedded[0] size:', embedded[0].size())
            print('hidden[0] size:', hidden[0].size())
            print('torch.cat((embedded[0], hidden[0]), 1)) size:', torch.cat((embedded[0], hidden[0]), 1).size())
...
trainEpochs(encoder1, attn_decoder1, 1000, print_every=50, plot_every=10)